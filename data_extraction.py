...
if dataset_type == "train":
    INPUT_DIR = r"C:\aty\Projects\dsv\dataset\training_data\annotations"
    OUT_PARQUET = os.path.join(SCRIPT_DIR, "parsed_OCR_data_train.parquet")

elif dataset_type == "test":
    INPUT_DIR = r"C:\aty\Projects\dsv\dataset\testing_data\annotations"
    OUT_PARQUET = os.path.join(SCRIPT_DIR, "parsed_OCR_data_test.parquet")
