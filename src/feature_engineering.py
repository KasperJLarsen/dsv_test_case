...
if dataset_type == "train":
    PARQUET_PATH = Path.cwd().parent / "dataset" / "parsed_OCR_data_train.parquet"
    OUT_PARQUET = Path.cwd().parent / "dataset" / "preprocessed_data_train.parquet"
elif dataset_type == "test":
    PARQUET_PATH = Path.cwd().parent / "dataset" / "parsed_OCR_data_test.parquet"
    OUT_PARQUET = Path.cwd().parent / "dataset" / "preprocessed_data_test.parquet"
